...
class CreateAssetsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('assets', function (Blueprint $table) {
            ...
            $table->integer("category_id")->nullable();                                      //资产类别
            ...
            $table->integer("admin_id")->nullable();                                           //管理员
            $table->integer("area_id")->nullable()->comment("所在位置");                                    //所在位置
            ...
            $table->integer('org_id')->nullable()->comment("所属公司");                        //公司id
