...
<div class="modal-body">
    <form id="signupForm1" class="form-horizontal " method="post" enctype="multipart/form-data" >
        ...
        <div class="row" >
            ...
            <div class="col-md-4" >
                <div class="form-group">
                    <label for="supplier_id" class="col-sm-4 control-label">资产数量</label>
                    <div class="col-sm-8">
                        <input type="text" name="sum" class="form-control" data-error-container="#error-block" placeholder="资产数量">
                    </div>
                </div>
            </div>
        </div>
