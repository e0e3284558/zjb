        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="spec" class="form-control" id="inputEmail3" placeholder="规格型号">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-4 control-label">金额</label>
                    <div class="col-sm-8">
                        <input type="text" name="money" class="form-control" id="inputEmail3" placeholder="金额">
                    </div>
                </div>
                <div class="form-group">
                ...
                {{--<div class="form-group">--}}
                    {{--<label for="inputEmail3" class="col-sm-4 control-label">所属公司</label>--}}

                    {{--<div class="col-sm-8">--}}
                        {{--<select name="owned_org_id" class="form-control">--}}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="use_time" class="form-control" id="use_time" placeholder="使用期限">
                    </div>
                </div>
            </div>
            <div class="col-sm-4" >
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select name="category_id" onchange="find(this.value)" id="category_id" class="form-control">
                            <option value=""></option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="SN_code" class="form-control" id="inputEmail3" placeholder="SN号">
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="col-sm-4" >
                ...
                <div class="form-group" style="position: relative;" >
                    <label for="inputEmail3" class="col-sm-4 control-label">所属部门</label>

                    <div class="col-sm-8">
                        <select id="department_id" name="use_department_id" class="form-control">
                            <option value=""></option>
                            @foreach($list6 as $v)
                                <option value="{{$v->id}}">{{$v->name}}</option>
                            @endforeach
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div id="uploader-demo">
                            ...
                            <input type="hidden" id="upload_id" name="img" value="">
                        </div>
