        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    <label class="col-md-5 control-label">退库单号</label>
                    <div class="col-md-7">
                        <p class="padding-top-7">{{$info->return_code}}</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="col-md-5 control-label">退库时间</label>
                    <div class="col-md-7">
                        <p class="padding-top-7">{{$info->return_time}}</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label class="col-md-5 control-label">退库处理人</label>
                    <div class="col-md-7">
                        <p class="padding-top-7">{{$info->return_dispose_user->name}}</p>
                    </div>
                </div>
            </div>
        </div>
