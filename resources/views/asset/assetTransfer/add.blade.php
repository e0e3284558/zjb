<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">调拨单</h4>
</div>
<div class="modal-body">
    <form id="signupForm1" class="form-horizontal " method="post" enctype="multipart/form-data" >
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select id="put_admin_id" data-error-container="#error-block" name="put_admin_id" class="form-control select2">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" disabled data-error-container="#error-block" class="form-control datepicker" data-date-date = "0d">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row" >
            <div class="col-md-6" >
                <div class="form-group">
                    <label for="name" class="col-sm-4 control-label">处理人<span style="color:red;">*</span></label>
                    <div class="col-sm-8">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="buy_time" class="col-sm-4 control-label">处理时间<span style="color:red;">*</span></label>
                    <div class="col-sm-8">
                        <input type="text" value="{{date('Y-m-d')}}" disabled data-error-container="#error-block" class="form-control datepicker" data-date-date = "0d">
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12" >
                <div class="form-group">
                    <label for="remarks" class="col-sm-2 control-label">调拨说明</label>
                    <div class="col-sm-10">
                        <textarea class="form-control" name="out_remarks" rows="2" style="resize: none;" placeholder="清理说明 ..."></textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row" >
            <a class="btn btn-default" href="{{url('asset_transfer/slt_asset')}}" data-toggle="modal" data-target=".bs-example-modal-md" >选择资产</a>
            <a href="javascript:;" class="btn btn-default" id="dlt-asset">删除</a>
        </div>

        <div class="row" style="overflow:auto;height:195px;margin-top:10px;">
            <table id="asset-transfer-asset" class="table table-striped table-bordered table-hove">
                <thead>
                <tr>
...
<script type="text/javascript" >
    ...
    $(document).ready(function () {
        $("#all").click(function(){
            if(this.checked){
                $("#asset-transfer-asset :checkbox").prop("checked", true);
            }else{
                $("#asset-transfer-asset :checkbox").prop("checked", false);
            }
        });

        $("#dlt-asset").click(function () {
            $("#asset-transfer-asset input[type='checkbox']:checked").each(function() {
                //判断
                if($(this).val()!="on"){
