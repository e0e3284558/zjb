...
<div class="modal-body">
    <form id="signupForm2" class="form-horizontal " method="post" enctype="multipart/form-data" >
        ...
        <div class="row" >
            ...
            <table class="layui-table" id="asset-transfer-add" lay-filter="data-asset-transfer-add" lay-data="">
                <thead>
                <tr>
                </tr>
                </thead>
...
<script type="text/javascript">
    ...
    $( document ).ready( function () {
        ...
        layui.use('table', function () {
            ...
            //执行渲染
            table.render({
                elem: '#asset-transfer-add' //指定原始表格元素选择器（推荐id选择器）
                , height: 410 //容器高度
                , url: '{{ url("asset_transfer/slt_asset?type=2") }}'
                , cols: [[
...
//                    {title:'ID',field:'id', width:80, sort: true},
        ...
        $('#submitAssetsForm2').click(function () {
            ...
            var checkStatus = table.checkStatus('dataAssetTransferAdd');
            var ids  = [];
            var tbody = $("#asset-transfer-asset tbody");
            $.each(checkStatus.data,function(i,v){
                ...
                var str = "<tr>" +
                    ...
                    "</tr>";
                if($('#asset-transfer-asset input[value="'+v.id+'"]').length < 1){
                    tbody.append(str);
                }
            });
        });
