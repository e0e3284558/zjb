<div class="ibox m-b-none">
    ...
    <div class="ibox-content margin-padding-0 relative-ibox-content">
        <form action="{{ url('brand') }}" class="padding-20" method="post" id="dep-form">
            <div class="form-group">
                <label class="control-label">
                    上级品牌<span class="required">*</span>
                </label>
                <div>
            ...
            <div class="form-group">
                ...
                <div>
                    <input type="text" placeholder="品牌编码" name="code" value="" class="form-control">
                    <span class="help-block">请输入品牌编码，<span class="bg-warning">提交之后不可修改</span></span>
                </div>
            </div>
            <div class="hr-line-dashed"></div>
            <div class="form-group">
                ...
                <div>
                    <input type="text" placeholder="品牌名称" name="name" value="" class="form-control">
            ...
            <div class="form-group">
                ...
                <div>
                    <textarea class="form-control" name="remarks" cols="5"  placeholder="品牌备注"></textarea>
                </div>
            </div>
            <div class="hr-line-dashed"></div>
            <div class="form-group">
