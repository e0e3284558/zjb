<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">合同修改</h4>
</div>
        ...
        <div class="row">
            ...
            <div class="col-md-6" >
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="first_party" value="{{$info->first_party}}" class="form-control" data-error-container="#error-block" placeholder="规格型号">
                    </div>
                </div>
            </div>
        ...
        <div class="row" >
            <div class="col-md-6" >
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="second_party" value="{{$info->second_party}}" class="form-control" data-error-container="#error-block" placeholder="规格型号">
                    </div>
                </div>
            </div>
            <div class="col-md-6" >
