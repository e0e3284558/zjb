...
<form action="{{url('consumables/goods/'.$goods->id)}}" method="post" id="signupForm1" class="form-horizontal">
    <div class="modal-body">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="{{$goods->coding}}" name="coding" placeholder="物品编码">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">物品名称</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="{{$goods->name}}" name="name" placeholder="物品名称">
                </div>
            </div>
            <input id="classify_id" type="hidden" value="{{$goods->classify_id}}" name="classify_id" value="">
            <script>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="{{$goods->norm}}" name="norm" placeholder="规格型号">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">单位</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="{{$goods->unit}}" name="unit" placeholder="单位">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="{{$goods->comment}}" name="comment" placeholder="备注">
                </div>
            </div>
            <!--dom结构部分-->
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <img id="thumb_img" src="{{url(id_to_img($goods->upload_id))}}" alt="" class="img-lg">
